...
export default function Screen1() {
  ...
  // Učitaj prethodne podatke i boje iz localStorage
  useEffect(() => {
  ...
  const getCountryColor = (country) => {
    ...
    // Dodela boje po državi koristeći hash funkciju
    let hash = 0;
  ...
  return (
    <div>
      ...
      <table>
        ...
        <tbody>
          {rows.map((r, i) => {
            const country = r.liga.split(' ')[0] || r.liga; // uzimamo prvu reč kao državu
